public class AkzeptablesRisiko extends Risiko {
    ...
    public void druckeDaten() {
        System.out.printf("Id %d Akzeptables Risiko \"%s\" aus %d/%d; Risikowert: %.2f€; Rückstellung: %.2f€\n", super.getId(), super.getBezeichnung(), super.getErstellungsdatum().getMonth().getValue(), super.getErstellungsdatum().getYear(), super.getKostenImSchadensfall(), this.ermittleRueckstellung());
    }
