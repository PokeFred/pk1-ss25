public class ExtremesRisiko extends InakzeptablesRisiko {
    ...
    public void druckeDaten() {
        System.out.printf("Id %d Extremes Risiko \"%s\" aus %d/%d; Versicherungsbeitrag: %.2f€; Maßnahme: \"%s\"", super.getId(), super.getBezeichnung(), super.getErstellungsdatum().getMonth().getValue(), super.getErstellungsdatum().getYear(), this.getVersicherungsbeitrag(), super.getMassnahme());
    }
}
